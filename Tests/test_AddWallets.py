...
class TestClass:
    ...
    def test_add_wallets_currencies_availability(self, driver):
        ...
        addWalletsPage.wait_until_element_visible(AddWalletsElements.AddWalletsButton, 30)
    ...
    def test_check_delete_popup(self, driver, prepare_for_delete_fixture):
        ...
        loginPage.wait_until_element_visible(AddWalletsElements.AddWalletsButton, 30)
    ...
    def test_check_popup_checkbox(self, driver):
        ...
        loginPage.wait_until_element_invisible(MyWallets.XEM, 2)
    ...
    @xray("QA-1706")
    def test_search_in_add_wallets(self, driver, clear_added_wallets_fixture):
